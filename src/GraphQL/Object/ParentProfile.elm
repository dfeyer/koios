...
module GraphQL.Object.ParentProfile exposing (accessLevel, address, country, creationDate, email, facebook, family, fax, firstname, id, instagram, lastname, locality, mastodon, mobile, name, phone, postalCode, profilePublic, profileValidated, twitter, username, website)
...
creationDate : SelectionSet (Maybe GraphQL.ScalarCodecs.DateTime) GraphQL.Object.ParentProfile
creationDate =
...
accessLevel : SelectionSet (Maybe Int) GraphQL.Object.ParentProfile
accessLevel =
...
username : SelectionSet (Maybe String) GraphQL.Object.ParentProfile
username =
