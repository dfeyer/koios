...
module GraphQL.Object.StudyPlanTopic exposing (SectionRequiredArguments, code, group, id, name, next, prev, section, sections, slug)
...
code : SelectionSet String GraphQL.Object.StudyPlanTopic
code =
